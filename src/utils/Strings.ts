...
const en = {
  ...
  trySearching: 'Try Searching Foods',
  ...
  partnerComing: 'Partner is Coming',
...
const ar = {
  ...
  trySearching: 'جرّب البحث عن الأطعمة',
  cartIsEmpty: 'سلتك فارغة',
  addSomeItem: 'يرجى إضافة بعض العناصر من القائمة',
  ...
  willBeDeliveredOn: 'سيتم التوصيل في',
  ...
  makePreferredMode: 'اجعل هذا الخيار المفضل لدي!',
  ...
  reset: 'إعادة تعيين',
  youreHere: 'أنت هنا',
  partnerComing: 'الشريك في الطريق',
  takeInvoicePlease: 'يرجى استلام هذه الفاتورة',
  UserDeatailUpdatedHeader: 'تم بنجاح',
  UserDeatailUpdatedMessage: 'تم تحديث بياناتك بنجاح!',
  loading: 'جارٍ التحميل...',
  userInfoHeader: 'معلومات المستخدم',
  taptoPick: 'اضغط للاختيار',
  image: 'صورة',
  video: 'فيديو',
  document: 'مستند',
  confirmToExitApp: 'تأكيد الخروج؟',
  confirmToExtDescription: 'هل أنت متأكد أنك تريد الخروج؟',
} as const
